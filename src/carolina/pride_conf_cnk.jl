...
JLD.save("PridePrej.jld", "corpus", corp, "sentances", word_per_sent, "data", hcat(sentances, nextword), "embtable", embtable)
...
embtable_index = Dict(word => ii for (ii, word) in enumerate(embtable2.vocab))
