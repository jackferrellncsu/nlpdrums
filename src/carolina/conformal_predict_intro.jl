...
"""
    nearest_neighbor(bag_df, new_index)

Find nearest neighbor for both versicolor and setosa
...
"""
    conformal(nonconf, ∈, bag_df, new_index)
    
Find confidence set for prediction
